...
import Ball from '../assets/ballpattern.jpg'
...
const Banner = () => {
  return (
    <Section>
        ...
        <Title>Join the  <br /> FIFA INU Club  </Title>
        <BtnContainer>
        <a href="https://t.me/Fifainu_Official" aria-label={"Join Now"} target="_blank" rel="noreferrer" >
        <JoiNow>
            Join Now
        </JoiNow>
        </a>
